...
public class SendPositionToRedis : MonoBehaviour {
    ...
    public IEnumerator Upload()
    {
        ...
        {
            if (MobileObject.transform.hasChanged)
            {
                ...
                //url.Add("http://172.20.10.8:8379/hset/" + ObjectName + "/x/" + posX);
                //url.Add("http://172.20.10.8:8379/hset/" + ObjectName + "/y/" + posY);
                //url.Add("http://172.20.10.8:8379/hset/" + ObjectName + "/z/" + posZ);

                url.Add("http://192.168.0.17:8379/hset/" + ObjectName + "/x/" + posX);
                url.Add("http://192.168.0.17:8379/hset/" + ObjectName + "/y/" + posY);
                url.Add("http://192.168.0.17:8379/hset/" + ObjectName + "/z/" + posZ);

                print(ObjectName + " has changed!");
                MobileObject.transform.hasChanged = false;
